...
#SBATCH -A NIKIFORAKIS-DRAY-SL2-CPU
#SBATCH -p icelake
...
#! SLURM ARRAY JOB - specify the number of array jobs
#SBATCH --array=0-9
...
##SBATCH --no-requeue
#SBATCH --output=/home/ajd246/code/project/slurm_log/simulation/%j.txt
#! #SBATCH --exclusive
...
application="../venv/bin/python3 generate/simulation.py --machine csd3 --array_id $ARRAY_ID --array_total $TOTAL_ARRAY_JOBS"
...
workdir="/home/ajd246/code/project"
